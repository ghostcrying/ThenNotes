...
# 移除模拟器arm64框架, 防止后续合并冲突
lipo -remove arm64 "${BUILD_DIR}/${CONFIGURATION}-iphonesimulator/lib${target_Name}.a" -o "${BUILD_DIR}/${CONFIGURATION}-iphonesimulator/lib${target_Name}.a"
